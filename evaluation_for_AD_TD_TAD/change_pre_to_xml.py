...
if __name__ == '__main__':
    ...
    if 'best_model' in args.pre_xml_file:
        args.pre_xml_file = args.pre_xml_file[:-16] + "_" + args.pre_xml_file[-15:]
    ...
    with open(args.pre_path, 'r', encoding='utf-8') as f_pre, open(args.gold_path, 'r', encoding='utf-8') as f_gold:
        ...
        # uncommon_pairs = dict()
        # count = 0
        # for key in sen_tree_map_dup:
        # 	if key in sen_tree_map:
        # 		count += 1
        # 		if sen_tree_map_dup[key] == sen_tree_map[key]:
        # 			common_pairs[key] = sen_tree_map_dup[key]
        # 		else:
        # 			uncommon_pairs[key] = sen_tree_map_dup[key]
        # print(len(common_pairs))
        #
        # assert sen_tree_map_dup == sen_tree_map
            ...
            if yes_not == '1':
                ...
                if len(entitys) == 0:  # NULL for this category&polarity
                    ...
                    for x in entitys:
                        ...
                        target_sub_seq = sentence[start: end]
